    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          >
            <Image src={logo} alt="Transcendent Labs logo" fill className="object-contain" priority />
          </Link>
        ...
        <div className="flex items-center gap-2 md:gap-3">
          <div className="hidden md:flex items-center gap-2">
              ...
              {mounted && (
                <>
                  <motion.div
                    ...
                    initial={false}
                    animate={{ left: currentLang === "en" ? "4px" : "calc(50% + 0px)" }}
            ...
            <Link aria-label="Search Transcendent Labs" href="/search" className="p-2 text-[var(--text-main)] hover:bg-[var(--text-muted)]/10 rounded-full transition-colors cursor-pointer">
