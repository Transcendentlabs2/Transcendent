...
import { ShoppingCart, ShieldCheck, Truck, ArrowRight, Microscope, Info } from "lucide-react";
...
// --- NUEVO SVG ANIMADO: ANILLO DE ESCÁNER ---
      ...
      <div className="relative min-h-screen w-full overflow-hidden bg-[var(--bg-page)] text-[var(--text-main)]">
        ...
        <main className="relative z-10 max-w-[1600px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
             ...
             {/* --- COLUMNA VISUAL (Izquierda / Top en Móvil) --- */}
             {/* CAMBIO: h-[45vh] en móvil para que no sea gigante. Sticky en Desktop */}
             ...
             {/* --- COLUMNA CONTENIDO (Derecha / Bottom en Móvil) --- */}
             <div className="relative px-6 py-10 lg:px-24 lg:py-24">
                ...
                {/* Título & Precio (Impacto Editorial) */}
                ...
                {/* Descripción Editorial (Columnas) */}
                <div className="mb-12">
                ...
                <div className="bg-[var(--glass-bg)] border border-[var(--glass-border)] p-6 rounded-2xl shadow-xl lg:sticky lg:bottom-10 z-30 backdrop-blur-md">
                   ...
                   <div className="grid grid-cols-2 gap-4 mt-4 pt-4 border-t border-[var(--glass-border)]">
                      <div className="flex items-center justify-center gap-2 text-[10px] text-[var(--text-muted)] uppercase tracking-wider">
                         <ShieldCheck className="w-3 h-3 text-emerald-500" /> HPLC Verified
                      </div>
                      <div className="flex items-center justify-center gap-2 text-[10px] text-[var(--text-muted)] uppercase tracking-wider">
                         <Truck className="w-3 h-3 text-[var(--color-brand-primary)]" /> Global Ship
                      </div>
                   </div>
                </div>
