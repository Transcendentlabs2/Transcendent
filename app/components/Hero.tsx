    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
          ...
          <motion.h1 variants={fadeUp} className="relative z-20 select-none text-center">
            ...
            */}
            <span className="block text-[10vw] md:text-[6rem] lg:text-[7rem] leading-[0.85] font-bold tracking-widest text-black/90 dark:text-white/10 font-display scale-105 origin-bottom transition-colors duration-500">
              TRANSCENDENT
            </span>
